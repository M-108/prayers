...
(function (C, r, g) {
  ...
  function y(a, b) {
    ...
    "+" === h
      ? (h = ["+"])
      : ((h = h.replace(/\+{2}/g, "+plus")), (h = h.split("+")));
    for (e = 0; e < h.length; ++e)
      (c = h[e]),
        z[c] && (c = z[c]),
        b && "keypress" != b && A[c] && ((c = A[c]), g.push("shift")),
        u(c) && g.push(c);
    h = c;
    e = b;
    if (!e) {
  ...
  function c(a) {
    ...
    function h(a, b, n, f, c, h) {
      ...
      for (g = 0; g < d._callbacks[a].length; ++g)
        if (
          ...
          var k;
          (k = "keypress" == m && !n.metaKey && !n.ctrlKey) ||
            ((k = e.modifiers),
            (k = b.sort().join(",") === k.sort().join(",")));
          k &&
            ((k = f && e.seq == f && e.level == h),
    ...
    function g(a, b, n, f) {
      d.stopCallback(b, b.target || b.srcElement, n, f) ||
        !1 !== a(b, n) ||
    ...
    function m(a, b, c, f, e) {
      ...
      1 < g.length
        ...
        : ((c = y(a, c)),
          ...
          h(c.key, c.modifiers, { type: c.action }, f, a, e),
      ...
      for (d = 0; d < f.length; ++d)
        f[d].seq
          ? f[d].level == k &&
            ((l = !0),
            (c[f[d].seq] = 1),
            g(f[d].callback, e, f[d].combo, f[d].seq))
          : l || g(f[d].callback, e, f[d].combo);
      f = "keypress" == e.type && p;
      e.type != v || u(a) || f || b(c);
      p = l && "keydown" == e.type;
    };
